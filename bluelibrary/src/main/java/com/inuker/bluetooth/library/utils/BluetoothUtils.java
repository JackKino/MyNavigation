...
public class BluetoothUtils {
    ...
    private static BluetoothLeAdvertiser mBBluetoothLeAdvertiser;
    ...
    public static BluetoothLeAdvertiser getBluetoothLeAdvertiser() {
        if (mBBluetoothLeAdvertiser == null) {
            mBBluetoothLeAdvertiser = mBluetoothAdapter.getBluetoothLeAdvertiser();//判断你的设备到底支持不支持BLE Peripheral。假如此返回值非空，你才可以继续有机会开发

        }
        return  mBBluetoothLeAdvertiser;
    }
